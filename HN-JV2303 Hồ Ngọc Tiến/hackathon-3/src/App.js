  ...
  return (
    <div className="App">
      ...
      <div className="card-product">
        <CardProducts
          img={
            "https://www.huyhoangmobile.vn/upload/images_product/sub_images/Iphone-pro-max_deep-purple_20220921122740.jpg"
          }
          title={"Iphone"}
          text={"dien thoai iphone"}
        />
        <CardProducts
          img={
            "https://cdn.tgdd.vn/Products/Images/42/231100/samsung-galaxy-m42-600x600-600x600.jpg"
          }
          title={"samsung"}
        ...
        <CardProducts
          img={
            "https://cdn.tgdd.vn/Products/Images/42/225964/oppo-a12s-600-600x600.jpg"
          }
          title={"oppo"}
          text={"dien thoai oppo"}
        />
         <CardProducts
          img={
            "https://www.huyhoangmobile.vn/upload/images_product/sub_images/Iphone-pro-max_deep-purple_20220921122740.jpg"
